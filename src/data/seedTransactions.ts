...
const EXPENSE_PLAN: [string, number, number, string][] = [
  ['exp_rent', 85000, 2, 'Godown rent — Bhosari'],
  ['exp_salary', 412000, 3, 'Staff salaries'],
  ...
  ['exp_rent', 85000, 32, 'Godown rent — Bhosari'],
  ['exp_salary', 405000, 33, 'Staff salaries'],
  ...
  ['exp_rent', 85000, 62, 'Godown rent — Bhosari'],
  ['exp_salary', 398000, 63, 'Staff salaries'],
