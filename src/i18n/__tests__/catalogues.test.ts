...
const TA_LATIN_ALLOWLIST =
  /^(GST|GSTIN|GSTR|HSN|SAC|UQC|IRN|IRP|PAN|TRN|CGST|SGST|IGST|VAT|B2B|B2C|FY|PDF|OTP|CSV|QR|UPI|OCR|SKU|HSN|PO|SEZ|UTR|LR|ID|URP|GSP|IRN|IRP|EWB|EWBs|Part-A|Part-B|AI|Google|WhatsApp|Lixi|Elixir|Books|Smart|ERP|Basic|Pro|Business|Free|K|L|Cr|M|B|AM|PM|e|E)$/;
